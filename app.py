...
st.markdown("""
    ...
    /* ĐỊNH DẠNG CSS ÉP ẢNH TẢI LÊN HOẶC MẶC ĐỊNH BO TRÒN TUYỆT ĐỐI */
    .founder-frame {
        text-align: center;
        padding: 10px;
    }
    ...
    /* Thiết kế thẻ bài chiến lược phẳng */
    .strategy-card {
...
# ==========================================
# 🌟 KHỐI XỬ LÝ TẢI ẢNH TRỰC TIẾP & HIỂN THỊ CHÚNG TÔI LÀ AI
# ==========================================
with st.expander("💎 CHÚNG TÔI LÀ AI & SỨ MỆNH ĐỊNH CHẾ PHỤNG SỰ"):
    
    # Thêm nút cho phép người dùng bấm để tự tải ảnh từ máy tính lên giao diện web
    uploaded_file = st.file_uploader("Tải ảnh chân dung của bạn từ máy tính lên giao diện (Định dạng JPG, PNG):", type=["jpg", "jpeg", "png"])
    ...
    with col_img:
        ...
        # KỊCH BẢN 1: Nếu người dùng có bấm tải file từ máy lên
        ...
        # KỊCH BẢN 2: Nếu không tải file từ máy, hệ thống quét file 'founder.jpg' cố định trên GitHub
        else:
            ...
            if os.path.exists(img_filename):
                ...
                # KỊCH BẢN 3: Giao diện bảo hộ đồ họa tạm thời nếu chưa có bất kỳ ảnh nào
                st.markdown("""
                    <div class="founder-frame">
...
st.markdown("""
    <div style="border-top: 1px solid #E2E8F0; padding-top: 20px; color: #64748B; font-size: 11px; line-height: 1.6;">
        ...
        <b>Tuyên báo từ chối trách nhiệm pháp lý:</b> Toàn bộ hệ thống tính toán so sánh, mô hình đối chiếu 12 quy trình dựa trên sách vĩ mô và biểu đồ trên nền tảng này được vận hành tự động bởi thuật toán phân tích định lượng. Đây là sản phẩm công nghệ giả lập hỗ trợ cấu trúc tài sản đầu tư, hoàn toàn không cấu thành lời mời chào mua bán, ủy thác, môi giới, hoặc tư vấn đầu tư chứng khoán có tính chất pháp lý. Khách hàng tự chịu trách nhiệm cho mọi hành vi phân bổ nguồn vốn trên thị trường thực tế.
        <br><br>
