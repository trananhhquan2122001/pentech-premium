...
st.markdown("""
    <style>
    /* ÉP TOÀN BỘ PHÂN VÙNG GIAO DIỆN VỀ NỀN TRẮNG TUYỆT ĐỐI VÀ CHỮ ĐEN ĐẬM */
    ...
    /* Đảm bảo tất cả các loại chữ đều hiển thị màu đen đậm rõ nét */
    ...
    /* Thanh điều hướng phẳng màu đen sang trọng trên nền trắng */
    .premium-header {
    ...
    /* KHUNG NHÀ SÁNG LẬP TRẦN ANH QUÂN NỀN TRẮNG VIỀN ĐEN ĐẬM */
    .founder-card {
    ...
    /* Thẻ bài 35 chiến lược kinh điển rõ mồn một */
    .strategy-card {
    ...
    /* MA TRẬN 3 GÓI ĐĂNG KÝ THU PHÍ SÁNG SỦA, HIỂN THỊ ĐỦ 100% */
    .price-grid-box {
        background-color: #FFFFFF;
        border: 2px solid #000000;
        border-radius: 4px;
    ...
    /* Thẻ VIP được thiết kế đen đặc để tạo điểm nhấn đặc quyền */
    ...
    /* Tùy biến thanh mở rộng Expander nền trắng chữ đen */
    ...
    /* Tùy biến ô nhập liệu Input viền đen nổi bật */
    input {
        background-color: #FFFFFF !important;
        color: #000000 !important;
        border: 2px solid #000000 !important;
    ...
    /* Nút bấm Form màu đen đặc, chữ trắng to rõ */
...
st.markdown("""
    <div class="premium-header">
        ...
        <div class="premium-subtitle">Hạ tầng Real-time 3 sàn • Giao diện nền trắng chữ đen dễ nhìn</div>
    </div>
""", unsafe_allow_html=True)
...
with col_box1:
    ...
    <div class="compare-box">
        ...
        <p style='color:#000000;'>• Giá Real-time: <b style='font-size:18px;'>{data_A['current']:,.0f} VNĐ</b></p>
        <p style='color:#000000;'>• <b>CHỈ SỐ: EPS {data_A['eps']:,.0f} VNĐ | ROE {data_A['roe']:.1f}% | ROI {data_A['roi']:.1f}%</b></p>
        <p style='color:#000000;'>• Tăng trưởng: +{data_A['growth']}% | Hào bảo vệ: <i>{data_A['moat']}</i></p>
    </div>
    """, unsafe_allow_html=True)
...
with col_box2:
    ...
    <div class="compare-box">
        ...
        <p style='color:#000000;'>• Giá Real-time: <b style='font-size:18px;'>{data_B['current']:,.0f} VNĐ</b></p>
        <p style='color:#000000;'>• <b>CHỈ SỐ: EPS {data_B['eps']:,.0f} VNĐ | ROE {data_B['roe']:.1f}% | ROI {data_B['roi']:.1f}%</b></p>
        <p style='color:#000000;'>• Tăng trưởng: +{data_B['growth']}% | Hào bảo vệ: <i>{data_B['moat']}</i></p>
    </div>
    """, unsafe_allow_html=True)
...
# ==========================================
# 💰 MA TRẬN 3 GÓI ĐĂNG KÝ THEO BỐ CỤC MỚI RÕ NÉT
# ==========================================
