...
# ==========================================
# 2. NGÔN NGỮ THIẾT KẾ SIÊU TƯƠNG PHẢN (PURE BLACK & WHITE TERMINAL)
# ==========================================
st.markdown("""
    <style>
    /* Ép toàn bộ nền về Đen Tuyệt Đối và Chữ về Trắng Tinh Khiết */
    ...
    h1, h2, h3, h4, h5, h6, p, label, span, strong, em { color: #FFFFFF !important; }
    div[data-testid="stMarkdownContainer"] p { color: #FFFFFF !important; }
    small { color: #FFFFFF !important; font-size: 12px; }

    /* Thanh điều hướng phẳng Đen - Trắng */
    .premium-header {
    ...
    .premium-subtitle { color: #FFFFFF !important; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.5px; }
    
    /* GIAO DIỆN NHÀ SÁNG LẬP TRẦN ANH QUÂN - SIÊU TƯƠNG PHẢN */
    .founder-card {
    ...
    .founder-name { font-size: 24px; font-weight: 800; color: #FFFFFF; margin-top: 15px; margin-bottom: 2px; }
    .founder-title { font-size: 13px; color: #FFFFFF; text-transform: uppercase; letter-spacing: 2px; font-weight: 700; }

    /* Thẻ bài 35 chiến lược Đen - Trắng rạch ròi */
    .strategy-card {
        background-color: #000000;
        padding: 20px;
        border: 2px solid #FFFFFF;
    ...
    .strategy-title { font-size: 16px; font-weight: 800; color: #FFFFFF !important; margin-bottom: 5px; }
    .book-tag { font-size: 11px; font-weight: 800; color: #000000 !important; background-color: #FFFFFF !important; padding: 2px 8px; border-radius: 0px; display: inline-block; margin-bottom: 8px; }
    ...
    /* MA TRẬN 3 GÓI THU PHÍ ĐẢM BẢO HIỂN THỊ ĐỦ VÀ CỰC KỲ RÕ CHỮ */
    .price-grid-box {
        background-color: #000000;
        border: 2px solid #FFFFFF;
        border-radius: 0px;
    ...
    .price-card-title { font-size: 18px; font-weight: 800; color: #FFFFFF; text-transform: uppercase; letter-spacing: 1px; }
    .price-card-amount { font-size: 34px; font-weight: 900; color: #FFFFFF; margin: 15px 0px 5px 0px; }
    
    /* Thẻ VIP đảo màu cực mạnh để dễ phân biệt */
    .price-grid-box.vip-tier {
        background-color: #FFFFFF;
        border: 2px solid #FFFFFF;
    }
    .price-grid-box.vip-tier .price-card-title { color: #000000 !important; }
    .price-grid-box.vip-tier .price-card-amount { color: #000000 !important; }
    .price-grid-box.vip-tier p, .price-grid-box.vip-tier li, .price-grid-box.vip-tier b { color: #000000 !important; }
    ...
    /* Nút bấm Form trắng tinh, chữ đen to rõ */
...
st.markdown("""
    <div class="premium-header">
        <div class="premium-title">Pentech Premium <span style='font-size:16px; color:#FFFFFF; font-weight:400;'>INSTITUTIONAL TERMINAL</span></div>
        <div class="premium-subtitle">Hạ tầng Real-time 3 sàn • Giao diện siêu tương phản Đen - Trắng</div>
    </div>
""", unsafe_allow_html=True)
...
with st.expander("💎 CHÚNG TÔI LÀ AI & SỨ MỆNH PHỤNG SỰ XÃ HỘI PENTECH PREMIUM", expanded=True):
    ...
    with col_mission_text:
        st.markdown(f"""
            <h3 style='color:#FFFFFF; margin-top:0; font-weight:800;'>Hạ tầng tri thức cho người Việt</h3>
            <p style='font-size:16px; line-height:1.7; color:#FFFFFF; text-align: justify;'>
                ...
                <br><br>
                <b style='font-size:17px; color:#FFFFFF; display:block; border-left:4px solid #FFFFFF; padding-left:12px; font-style:italic; margin-bottom:10px;'>
                    "Sử mệnh của chúng tôi là phụng sự người nghèo, hỗ trợ cộng đồng chưa có kiến thức chuyên sâu về tài chính tại Việt Nam có thể tự tin đầu tư, tích lũy an toàn và bền vững từ những số vốn nhỏ nhất."
                </b>
...
with st.expander("⚙️ BAN ĐIỀU HÀNH: Tải ảnh chân dung thay thế lên hệ thống"):
    ...
    if uploaded_image is not None:
        ...
        st.success("🎉 Đã đồng bộ ảnh chân dung CEO Trần Anh Quân vĩnh viễn vào hệ thống! Vui lòng F5 để kiểm tra.")
...
with col_box1:
    ...
    <div class="compare-box">
        <h4 style='margin-top:0; border-bottom:2px solid #FFFFFF; padding-bottom:5px; color:#FFFFFF; font-weight:800;'>📊 TRẠM A: {tkA} ({data_A['exchange']})</h4>
        <p>• Doanh nghiệp: <b>{data_A['name']}</b></p>
        <p>• Phân ngành: <span style='background-color:#FFFFFF; color:#000000; padding:2px 6px; font-weight:800;'>{data_A['sector']}</span></p>
        <p>• Giá Real-time: <b style='font-size:18px;'>{data_A['current']:,.0f} VNĐ</b></p>
        <p>• <b>CHỈ SỐ: EPS {data_A['eps']:,.0f} VNĐ | ROE {data_A['roe']:.1f}% | ROI {data_A['roi']:.1f}%</b></p>
...
with col_box2:
    st.markdown(f"""
    <div class="compare-box">
        <h4 style='margin-top:0; border-bottom:2px solid #FFFFFF; padding-bottom:5px; color:#FFFFFF; font-weight:800;'>📊 TRẠM B: {tkB} ({data_B['exchange']})</h4>
        <p>• Doanh nghiệp: <b>{data_B['name']}</b></p>
        <p>• Phân ngành: <span style='background-color:#FFFFFF; color:#000000; padding:2px 6px; font-weight:800;'>{data_B['sector']}</span></p>
        <p>• Giá Real-time: <b style='font-size:18px;'>{data_B['current']:,.0f} VNĐ</b></p>
        <p>• <b>CHỈ SỐ: EPS {data_B['eps']:,.0f} VNĐ | ROE {data_B['roe']:.1f}% | ROI {data_B['roi']:.1f}%</b></p>
        <p>• Tăng trưởng: +{data_B['growth']}% | Hào bảo vệ: <i>{data_B['moat']}</i></p>
    </div>
    """, unsafe_allow_html=True)

# Biểu đồ diễn biến đường dòng tiền Đen - Trắng sắc nét
dates = [datetime.now() - timedelta(days=x) for x in range(100, 0, -1)]
fig = go.Figure()
fig.add_trace(go.Scatter(x=dates, y=[data_A['current'] * (0.88 + (i*0.0014)) for i in range(100)], mode='lines', name=tkA, line=dict(color='#FFFFFF', width=3)))
fig.add_trace(go.Scatter(x=dates, y=[data_B['current'] * (0.86 + (i*0.0016)) for i in range(100)], mode='lines', name=tkB, line=dict(color='#FFFFFF', width=1.5, dash='dot')))
fig.update_layout(
    paper_bgcolor="#000000", plot_bgcolor="#000000", margin=dict(l=10, r=10, t=10, b=10), height=240,
    legend=dict(font=dict(color="#FFFFFF", size=12)),
    xaxis=dict(gridcolor="#222222", tickfont=dict(color="#FFFFFF", size=12)),
    yaxis=dict(gridcolor="#222222", tickfont=dict(color="#FFFFFF", size=12))
)
...
with col_f1:
    st.markdown("""<div class="strategy-card"><div class="book-tag">KỶ NGUYÊN SỐ</div><h4 style='margin-top:0; font-weight:800;'>1. CÔNG NGHỆ BÁN DẪN & AI ĐỊNH LƯỢNG</h4><p style='font-size:14px; color:#FFFFFF;'>Hạ tầng vi mạch và các thuật toán máy học tự động hóa (Tiêu biểu như FPT) nắm giữ độc quyền phân phối và tăng trưởng bền vững dài hạn.</p></div>""", unsafe_allow_html=True)
with col_f2:
    st.markdown("""<div class="strategy-card"><div class="book-tag">HẠ TẦNG KẾT NỐI</div><h4 style='margin-top:0; font-weight:800;'>2. VIỄN THÔNG 5G & LOGISTICS SỐ</h4><p style='font-size:14px; color:#FFFFFF;'>Mạng lưới trạm phát sóng liên quốc gia và chuỗi vận tải chuyển phát nhanh khép kín (Tiêu biểu như VGI, CTR, VTP) phòng vệ lạm phát tối ưu.</p></div>""", unsafe_allow_html=True)
with col_f3:
    st.markdown("""<div class="strategy-card"><div class="book-tag">TIÊU DÙNG THIẾT YẾU</div><h4 style='margin-top:0; font-weight:800;'>3. TIÊU DÙNG SẠCH & Y TẾ CHUỖI ĐỘC QUYỀN</h4><p style='font-size:14px; color:#FFFFFF;'>Sự bùng nổ nhu cầu thực phẩm đóng gói thương hiệu và chuỗi dược phẩm bán lẻ (Tiêu biểu như MCH, FRT) bền vững bất chấp chu kỳ suy thoái.</p></div>""", unsafe_allow_html=True)


# ==========================================
# 🏛️ HỆ THỐNG ĐÀO TẠO 35 CHIẾN LƯỢC ĐẦU TƯ KINH ĐIỂN
# ==========================================
...
for strat in strategies_35:
    with st.expander(f"📖 CHIẾN LƯỢC {strat['id']}: {strat['title'].upper()}"):
        ...
        <div class="strategy-card">
            ...
            <p style='font-size:15px; line-height:1.6; color:#FFFFFF;'>{strat['desc']}</p>
        </div>
        """, unsafe_allow_html=True)


# ==========================================
# 💰 ĐỒNG BỘ 3 GÓI ĐĂNG KÝ VIP SIÊU TƯƠNG PHẢN
# ==========================================
...
with col_p1:
    ...
    <div class="price-grid-box">
        ...
        <p style='color:#FFFFFF; font-size:13px; margin-bottom:15px;'>Phân khúc đại chúng khởi đầu</p>
        <hr style='border-color:#FFFFFF; margin:15px 0; border-width: 1px;'>
        <ul style='text-align:left; font-size:14px; list-style:none; padding:0; line-height:2.4;'>
...
with col_p2:
    ...
    <div class="price-grid-box">
        ...
        <p style='color:#FFFFFF; font-size:13px; margin-bottom:15px;'>Phân khúc Nhà đầu tư độc lập</p>
        <hr style='border-color:#FFFFFF; margin:15px 0; border-width: 1px;'>
        <ul style='text-align:left; font-size:14px; list-style:none; padding:0; line-height:2.4;'>
...
with col_p3:
    ...
    <div class="price-grid-box vip-tier">
        ...
        <p style='font-size:13px; margin-bottom:15px; font-weight:700;'>Đặc quyền Ban điều hành / Chủ doanh nghiệp</p>
        <hr style='border-color:#000000; margin:15px 0; border-width: 1px;'>
        <ul style='text-align:left; font-size:14px; list-style:none; padding:0; line-height:2.4;'>
...
with col_contact:
    st.markdown(f"""
        <div style="background-color: #000000; padding: 25px; border: 2px solid #FFFFFF; height: 195px; border-radius: 0px;">
            <span style="color: #FFFFFF; font-size: 12px; display: block; margin-bottom: 5px; font-weight:700; letter-spacing:1px;">🏢 ĐƯỜNG DÂY NÓNG BAN ĐIỀU HÀNH QUỸ</span>
            <span style="font-size: 30px; font-weight: 900; color: #FFFFFF; display: block; letter-spacing: -1px;">0327.625.853</span>
            <p style="font-size: 14px; color: #FFFFFF; margin-top: 12px; line-height: 1.5;">
...
st.markdown("""
    <div style="border-top: 2px solid #FFFFFF; padding-top: 20px; color: #FFFFFF; font-size: 12px; line-height: 1.6;">
        <b style="color: #FFFFFF; font-size: 14px; display: block; margin-bottom: 5px;">💎 PENTECH PREMIUM FINANCIAL TECHNOLOGY CORPORATION</b>
        ...
        <br><br>
        <div style="text-align: center; color: #FFFFFF; font-weight: bold;">© 2026 Pentech Premium. All corporate rights reserved. Power of Quantitative Python Logics.</div>
    </div>
""", unsafe_allow_html=True)
